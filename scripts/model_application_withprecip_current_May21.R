...
anim_save(aa, filename = "data/gifs/ard_points_allvars_3class_Sep26_frank.gif")

system("aws s3 cp data/gifs/ard_points_allvars_3class_Sep26_frank.gif s3://earthlab-amahood/wet_dry/model_results/summer19_model_results/gifs/ard_points_allvars_3class_wmuc_frank.gif")
