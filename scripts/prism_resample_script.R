...
#### extract annual precip anomaly to gb training data
gbd <- dplyr::mutate(gbd, precip_anomaly = precip_anomaly_vec)

#### save new training data with precip as a csv and upload to s3
write.csv(gbd, file = "data/gbd_train_w_precip_5_20_19.csv")
system("aws s3 cp data/gbd_train_w_precip_5_20_19.csv s3://earthlab-amahood/data/PRISM_precip_annual/gbd_train_w_precip_5_20_19.csv")
